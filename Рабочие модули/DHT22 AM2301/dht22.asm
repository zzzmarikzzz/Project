...
;------------------------------------------------------------------------------
	.equ	DHTPORT	=	PORTD		; Порт МК, где висит DHT22
	.equ	DHTPIN	=	PIND		; Пин МК, где висит DHT22
	.equ	DHTDDR	=	DDRD		; DDR МК, где висит DHT22
	.equ	DHTDAT	=	PD6			; Ножка порта, где висит DHT22
...
DDD:	LDI		XH, HIGH(C4P*500)	; выжидаем 500 мкс (1/2 от 1мс)
	LDI		XL, LOW(C4P*500)
	RCALL		DelayDHT22
