...
;------------------------------------------------------------------------------
.equ	OW_PORT	= PORTA				; Порт МК, где висит 1-Wire
.equ	OW_PIN	= PINA				; Порт МК, где висит 1-Wire
.equ	OW_DDR	= DDRA				; Порт МК, где висит 1-Wire
.equ	OW_DQ	= PA0				; Ножка порта, где висит 1-Wire
