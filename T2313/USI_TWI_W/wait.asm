;------------------------------------------------------------------------------
; Вместо DVUS(500) - указать : частота в MHz/4*500
;для 4.3 MHz == 600
;для 9.6 MHz == 1200
;для  12 MHz == 1500
;для  16 MHz == 2000
...
;------------------------------------------------------------------------------
		...
		; вычисляет величину для указанного времени в микросекундах, которую нужно передать Wait4xCycles чтобы получить желаемую задержку
